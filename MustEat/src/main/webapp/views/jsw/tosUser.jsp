...
<body>
	...
	<div class="wrap-tos">
        ...
        <div class="table-tos">
            ...
            <table width="100%" style="border:1px solid rgb(231, 216, 241); border-collapse:collapse; margin-top:3%;">
                ...
                <tr>
                    <td style="padding: 3% 3% 3% 3%;">
                            ...
                            <h6>게시등록일 : xxxx-xx-xx</h6>
                            <br>

                            <b>제 1 조 목적</b>
                            <br>
                            이 약관은 (주)여기가조(이하 "회사")에서 제공하는 MUSTEAT 및 MUSTEAT에서 제공하는 제반 서비스(이하 "서비스")에 접속과 사용자에 의해서 업로드 및 다운로드 되어 표시되는 모든 정보, 텍스트, 이미지 및 기타 자료를 이용하는 이용자(이하 "회원")와 서비스 이용에 관한 권리 및 의무와 책임사항, 기타 필요한 사항을 규정하는 것을 목적으로 합니다.
                            ...
                            <b>제4조 용어의 정의</b>
                            <br>
                            ① 서비스: 개인용 컴퓨터 (PC), TV, 휴대형 단말기, 전기통신설비 등 포함 각종 유무선 장치와 같이 구현되는 단말기와 상관없이 회원이 이용할 수 있는 MUSTEAT 및 MUSTEAT 관련 제반 서비스를 의미합니다. 제반 서비스에는 개발자 및 서비스 제공자가 MUSTEAT Open Application Programming Interface 서비스와 이를 이용하여 개발한 API 응용 애플리케이션 또는 웹서비스도 포함됩니다.
                            <br>
                            ...
                            <b>제5조 이용계약의 체결</b>
                            <br>
                            ① 이용계약은 회원이 MUSTEAT 서비스 및 제반 서비스에서 제공하는 회원 가입 페이지에서 서비스 이용약관에 동의한 후 이용신청을 하고 신청한 내용에 대해서 회사가 승낙함으로써 체결됩니다.
                            <br>
                            ...
                            <b>제6조 개인정보보호 의무</b>
                            <br>
                            ① 회사는 정보통신망법 등 관계 법령이 정하는 바에 따라 회원의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 관련법 및 회사의 개인정보처리방침이 적용됩니다. 다만, 회사의 공식 사이트 이외의 링크된 사이트에서는 회사의 개인정보취급방침이 적용되지 않습니다
                            <br>
                            ...
                            <br>
                            ③ 회사는 서비스를 이용하는 회원으로부터 제기되는 의견이나 불만이 정당하다고 인정할 경우를 이를 처리하여야하 합니다. 이때 처리과정에 대해서 고객에게 메일 및 게시판 등의 방법으로 전달합니다.
                            <br>
                            ...
                            <br>
                            - MUSTEAT 및 MUSTEAT 통합계정 서비스
                            <br>
                            - 기타 회사가 추가 개발하거나 다른 회사와의 제휴계약 등을 통해 회원에게 제공하는 일체의 서비스
                            <br>
                            ③ 회사는 정보통신설비의 보수점검, 교체 및 고장, 통신두절 또는 운영상 상당한 이유가 있는 경우 서비스의 제공을 일시적으로 중단할 수 있습니다. 이 경우 회사는 회원에게 공지사항 게시판 및 메일 등의 방법으로 통지합니다. 다만, 회사가 사전에 통지할 수 없는 부득이한 사유가 있는 경우 사후에 통지할 수 있습니다.
                            <br>
                            ④ 회사는 회원과 별도로 서면 계약을 체결하여 MUSTEAT 서비스 및 제반 서비스의 브랜드 특성을 이용할 수 있는 명시적인 권리를 부여하지 아니하는 한, 회원에게 회사 또는 서비스의 상호, 상표, 서비스표, 로고, 도메인 네임 및 기타 식별력 있는 브랜드 특성을 이용할 수 있는 권리를 부여하지 않습니다.
                            <br>
                            ⑤ 회사가 제공하는 서비스의 형태와 기능, 디자인 등 필요한 경우 수시로 변경되거나, 중단될 수 있습니다. 회사는 이 경우 개별적인 변경에 대해서 회원에게 사전 통지하지 않습니다. 다만, 회원에게 불리한 것으로 판단되는 경우 전자우편으로 통하여 이를 공지합니다.
                            <br>
                            ⑥ 전항에 의해서 제공되는 서비스가 변경 및 중단될 경우 무료로 제공되는 서비스에 대해서는 회원에게 별도로 보상하지 않습니다.
                            
                            <br><br>

                            <b>제 10조의 1 포인트의 적립 및 지급정지</b>
                            <br>
                            ① "포인트"란 “회원”이 "서비스"에서 포인트가 지급되는 특정 행위(식당평가, 회사가 제공하는 방식 등의 활동)를 하는 경우 다코포인트, 다코캐시 등 명칭에 상관없이 회사가 임의로 책정하거나 조정하여 지급하는 일정한 계산 단위를 갖는 서비스 상의 가상 데이터를 의미(이하 “포인트”라 합니다)합니다.
                            <br>
                            ② 회사는 이용회원이 상품의 구매, 맛집 평가 등 콘텐츠의 작성, 이벤트 참여 등 '서비스'를 이용하는 경우, 회사의 정책에 따라 이용회원에게 포인트를 무상 적립해줄 수 있습니다.
                            <br>
                            ③ “포인트”는 재산적 가치가 없기 때문에 금전으로 환불 또는 전환할 수 없습니다.
                            <br>
                            ④ “포인트”는 “회사”가 제공하는 방식으로 사용할 수 있습니다. 다만 “서비스”의 효율적 이용을 지원하거나 “서비스” 운영을 개선하기 위해 필요한 경우 일부 또는 전부를 조정할 수 있습니다.
                            <br>
                            ⑤ “포인트”는 양도, 상속, 대여, 담보의 목적으로 사용할 수 없습니다. 만일 “회원”이 “회사”가 승인하지 않은 방법으로 포인트를 사용한 사실이 확인될 경우 “회사”는 포인트 사용을 취소하거나 “회원” 자격을 정지 또는 해지할 수 있습니다.
                            <br>
                            ⑥ 회원은 다음의 행위를 하여서는 안됩니다.
                            <br>
                            - “회원”이 “회사”의 “서비스” 운영을 고의 및 과실로 방해(예, 홍보성 후기, 어뷰징 또는 업무상 지장을 초래하거나 다수 “회원＂의 이익에 배치 되는 행위 등)라고 관리자가 판단하는 경우
                            <br>
                            - “회사”가 인정하지 않는 방법으로 “포인트” 등을 적립하거나 사용하는 행위
                            <br>
                            - 직접 방문하지 않은 것으로 판단되는 평가를 작성하는 행위
                            <br>
                            - 외부 게시물, 사진 또는 텍스트를 도용하는 행위
                            <br>
                            - 평가 반려 또는 숨김 처리되는 행위를 2회이상 반복하는 행위
                            <br>
                            - 서비스 내에 게시된 체크인 사진 처리기준을 위배하는 행위
                            <br>
                            - 서비스 내에 게시된 평가 사진 처리기준을 위배하는 행위
                            <br>
                            - 서비스 내에 게시된 평가 처리기준을 위배하는 행위
                            <br>
                            - 타인의 정보 도용 하거나 타인의 계정을 사용하여 “서비스”를 이용하는 경우
                            <br>
                            ⑦ 본조 제 6항의 어느 하나에 해당된다고 관리자가 판단하는 경우 관리자는 해당 회원에 대해서 포인트 지급을 일시적 또는 영구적으로 정지할 수 있습니다. 또한 이러한 행위가 서비스 운영에 심각한 지장을 초래한다고 관리자가 판단하는 경우 제 9조의 2항에 의해 서비스의 이용정지/계약의 해지 등 서비스 이용 제한, 수사 기관에의 고발 조치 등 합당한 조치를 취할 수 있습니다.

                            <br><br>

                            <b>제11조 광고의 게제</b>
                            <br>
                            ① 회사는 서비스 운영과 관련하여 회원정보(닉네임 정보로 한정), 고객이 입력한 정보를 활용하여 광고를 게재할 수 있습니다. 회원은 서비스 이용 시 노출되는 맞춤 광고 게재에 대해 동의합니다.
                            <br>
                            ② 회사는 서비스상에 게재되어 있거나 서비스를 통한 광고주의 판촉활동에 회원이 참여하거나 교신 또는 거래를 함으로써 발생하는 손실과 손해에 대해 책임을 지지 않습니다.

                            <br><br>
                            
                            <b>제12조 전자우편을 통한 정보의 제공</b>
                            <br>
                            ...
                            <br>
                            ④ 회사가 본 약관 제9조의 위반 행위를 조사하는 과정에서 당해 회원 ID및 도메인이 특정 위반행위에 직접적으로 관련되어 있는 경우 등 다른 회원의 권익 보호 및 서비스의 질서유지를 위해 불가피할 경우에는 해당 ID 및 도메인의 이용을 일시적으로 정지할 수 있습니다. 이에 대해 회원은 서비스 홈페이지 또는 전자 우편 등을 통해 이의신청을 할 수 있습니다.

                            <br><br>

                            <b>제14조 게시물의 권리와 책임</b>
                            <br>
                            ...
                            <br>
                            ④ 회원은 자신이 서비스 내에 게시한 `회원정보(닉네임 정보로 한정)'나 `게시물(리뷰, 사진, 동영상, 링크, 체크인 등)'에 대하여 회사에게 다음과 같은 목적으로 사용하는 것을 허락합니다.
                            <br>
                            - 회사에서 운영하는 다른 서비스 또는 회사의 사업과 관련된 제3자(개인, 단체, 법인 및 이들이 운영하는 서비스나 어플리케이션 등)에게 무상 또는 유상으로 회원정보(닉네임 정보로 한정) 및 게시물을 필요한 범위에 따라 일부를 수정, 편집하여 복제ㆍ전송ㆍ전시ㆍ배포 할 수 있습니다.
                            <br>
                            ...
                            <br>
                            ④ 회사는 전항에도 불구하고, 저작권법 및 컴퓨터프로그램보호법을 위반한 불법프로그램의 제공 및 운영방해, 정보통신망법을 위반한 불법통신 및 해킹, 악성프로그램의 배포, 접속권한 초과행위 등과 같이 관련법을 위반한 경우에는 즉시 영구이용정지를 할 수 있습니다.
                            <br>
                            ...
                            <b>부칙</b>
                            <br><br>
                            <b>이 약관은 2022년 8월 8일부터 적용하고 이전의 모든 약관의 내용에 우선하여 적용됩니다.</b>
