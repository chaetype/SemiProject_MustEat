<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.ArrayList, com.mz.store.model.vo.Store"%>
<%
...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=5083115c1fb16d0c71e6b310c47c7609"></script>
...
<body>
	...
	<div class="wrap31">
		...
		<div class="outer22">
			<hr>
			<h3><%=city.getLocalSi() + " "%><%=city.getLocalGu() %></h3>
			<br>
				...
				<div class="wrap55" style="display: inline-block;">
					<div class="input-group mb-3">
						<input type="text" name="findKeyword"
							class="form-control input-text" placeholder="검색할 내용을 입력해주세요"
		...
		<div class="wrap32">
			<% for(Store s : list) { %>
			<div class="thumb1">
				<input type="hidden" value="<%=s.getStoreNo() %>"> <img
					src="<%=contextPath%>/<%=s.getStoreImgPath() %>" alt=""
