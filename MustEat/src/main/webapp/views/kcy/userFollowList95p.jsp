<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.ArrayList, com.mz.member.model.vo.Follow "%>
<%
...
.outer661 {
	...
	margin-top: 50px;
	background-image:
		url("<%=request.getContextPath()%>/resources/image/cy/retrobg.jpg");
}
</style>
</head>
<body>
		...
		<div class="outer661">
			...
			<div class="outer66">
				...
				<div class="thumbnail66">
					<img src="<%=contextPath%>/resources/image/mz.png"
				...
				<div class="info66">
					...
					<br> <a class="btn1"
						style="padding: 0.2em 1.2em; margin: 0 0.1em 0.1em 0;"
						onclick="return unfollow(<%=f.getFollowNo()%>);">Unfollow</a>
				</div>
			</div>
			<br>
			<hr>
