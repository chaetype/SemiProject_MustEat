...
<%
	...
	// 배송완료 '월'
	ArrayList<OrderPro> month = (ArrayList<OrderPro>)request.getAttribute("orderMonth");
	// 배송완료 상품 목록 리스트
	ArrayList<OrderPro> list = (ArrayList<OrderPro>)request.getAttribute("orderList");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<!-- 배송완료 해당 카테고리에 속하는 목록들만 보여지는 페이지 -->
...
<%@include file="../common/menubar.jsp" %>
	...
	<!-- 주문현황 리스트 -->
	  ...
	  <!-- 상품 '더보기' 영역!!! -->
	  <% if ( list.size() >= 10) { %> <!-- 상품 10개 이하면 안보이도록 설정 -->
	  <div class="viewMore">
