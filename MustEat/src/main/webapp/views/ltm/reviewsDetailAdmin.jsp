...
<body>
    ...
    <div class="outer">
        ...
        <table class="rwd-table" width="80%" style="table-layout:fixed">   
            <tbody>
                ...
                <tr>
	                <th>제목</th>
	                <td>
                        <p align=left style="height: 300px;">여기는 테이블 간 공간이 벽으로 아주 잘 분리되어 있어서 프라이빗 룸 느낌이 난다 데이트하기도 좋고 지인들과 도란도란 대화 나누며 깔끔하게 식사하기 좋다. 음식도 맛있다여기는 테이블 간 공간이 벽으로 아주 잘 분리되어 있어서 프라이빗 룸 느낌이 난다 데이트하기도 좋고 지인들과 도란도란 대화 나누며 깔끔하게 식사하기 좋다. 음식도 맛있다여기는 테이블 간 공간이 벽으로 아주 잘 분리되어 있어서 프라이빗 룸 느낌이 난다 데이트하기도 좋고 지인들과 도란도란 대화 나누며 깔끔하게 식사하기 좋다. 음식도 맛있다</p>
                    </td>
	            </tr>
            </tbody>
        </table> 
        ...
        <br>
        <br>
        <div style="width: 1200px; padding-left:45%;">
